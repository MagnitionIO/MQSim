...
protected:
	...
	static void handle_transaction_serviced_signal_from_PHY(Sim_Object *instance, NVM_Transaction_Flash *transaction);
	static void handle_channel_idle_signal(MQSimEngine::Sim_Object *, flash_channel_ID_type);
	static void handle_chip_idle_signal(MQSimEngine::Sim_Object *, NVM::FlashMemory::Flash_Chip *chip);
